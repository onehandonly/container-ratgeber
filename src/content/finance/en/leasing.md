---
title: "Leasing a container: full and partial payout, residual value, tax"
label: "Leasing"
description: "How container leasing works: full payout or partial payout with residual value, term, tax treatment, cost compared with buying, and who it suits."
lang: "en"
lead: "Leasing spreads the acquisition of a container over fixed monthly instalments that count as an expense for the business. It is not cheaper than buying – it preserves liquidity and makes costs predictable."
parent: "kauf"
order: 11
readingTime: 10
updated: 2026-09-25
...
Classification in the individual case is a matter for tax advice; the basics of depreciation are in [Containers and tax](/en/ratgeber/container-steuer-abschreibung).
...
1. **Total cost:** add up all instalments, fees and residual value and compare with cash purchase and hire purchase.
2. **Residual value and put option:** how high is the residual value, who decides on takeover, and at what price?
3. **Termination:** usually excluded during the basic term. What happens if you no longer need the container early?
4. **Insurance and maintenance:** almost always your obligation. Clarify which insurance is required.
5. **Return condition:** what counts as normal wear, and what will be charged?
6. **Relocation:** may the container be moved, and must this be reported?

## Who leasing suits

Leasing pays off for businesses that use a container for several years, prefer to deploy their capital in the core business and value fixed monthly costs. If you definitely want to keep the container and can pre-finance the VAT at the start, [hire purchase](/en/kaufen-mieten/kauf/mietkauf) is often cheaper. If you need it for one project only, [rental](/en/kaufen-mieten/miete) is the better choice.
