---
title: "Stacking and coupling containers: structure, hardware and limits"
description: "How containers are stacked on top of each other and coupled side by side: corner castings, connecting hardware, structural limits, the joint between modules, and when planning permission applies – with a pre-build checklist."
lang: "en"
category: "Basics"
icon: "ruler"
readingTime: 10
...
updated: 2026-09-26
lead: "Containers are built to be stacked – but not every stack is automatically safe. What the corner castings actually carry, when a structural engineer becomes mandatory, and what matters at the joint between coupled modules."
order: 21
draft: false
---
...
**Room and office containers (all-round or modular containers)** are not built to ISO standard, but they are deliberately fitted with the same corner castings and compatible module grids so they can be stacked and coupled the same way. Dimensions and construction of this modular building method are covered in [Container sizes and dimensions](/en/ratgeber/container-groessen-und-masse).
...
- **Foundation and load path.** The more storeys are stacked, the greater the point load under the four corner castings of the bottom container. Foundation details are covered in [Container foundations](/en/ratgeber/container-fundament).
...
1. **Structural reserve in the frame.** Even with the dividing wall gone, the corner posts and roof frame of both modules still need to carry their own load independently. Manufacturers offer reinforced coupling frames for exactly this reason.
2. **Sealing the joint.** Two coupled modules move slightly against each other with temperature changes. A rigid seal tends to crack here sooner than a flexible joint with compression tape or a proper joint profile.
3. **Thermal bridging at the joint.** The seam between two insulated modules is one of the most common places for condensation and mould, because the insulation layer is interrupted there. A continuous insulation layer or an insulated joint profile is therefore not a cosmetic detail but a matter of building physics. Background on this in [Thermal bridges in containers](/en/ratgeber/waermebruecken-container).
