---
title: "Sanitary containers: equipment, connections & costs"
description: "Sanitary containers at a glance: toilet, shower and washroom variants, connections for water and waste water, frost protection and hygiene, plus rental and purchase prices."
lang: "en"
...
updated: 2026-08-01
lead: "Toilets, showers and washbasins where there is no plumbing. Which variants exist, what has to be connected and what it costs."
order: 24
draft: false
---
...
| --- | --- | --- |
| **Toilet container** | 2 – 6 WC cubicles, sometimes urinals, wash trough or individual basins, mirrors | Construction site, event, public area |
| **Shower container** | 2 – 6 shower cubicles with anteroom, shelves, hooks, floor drain, water heater | Refurbishment, sports facility, accommodation, camp |
| **Combined WC + shower** | 1 – 2 toilets, 1 – 2 showers, washbasins, shared anteroom | Small sites, residential modules, holiday camps |
| **Separate female / male** | Two separate entrances, mirrored layout, sometimes additional urinals | Larger sites, businesses, accommodation |
| **Accessible version** | Larger cubicle, turning circle, support rails, wheelchair-accessible basin, alarm, ramp | Public use, events, administration |
...
The technical hook-up drives cost and effort far more strongly than the interior fittings do.
...
| --- | --- | --- |
| **Electric instantaneous heater** | Compact, unlimited quantity, no warm-up | Requires high connected load |
| **Storage cylinder / boiler** | Low connected load, inexpensive | Limited quantity, heat-up time, space required |
| **Gas instantaneous heater** | Independent of the grid, high output | Cylinder logistics, flue routing, stricter inspection duties |
...
A sanitary container is only as good as its cleaning. Unlike storage or office containers, day-to-day operation decides whether people accept it.

The following orders of magnitude have proven useful as guidance for cleaning intervals:

| Use | People | Cleaning interval |
| --- | --- | --- |
| **Construction site, ongoing** | 10 – 20 | 2 – 3 × per week |
| **Construction site, large unit** | over 30 | daily |
| **Event** | fluctuating, high | several times a day, attendant on site |
...
> **Important note:** all figures are rough approximate ranges (as of 2026) for orientation. Actual prices depend on equipment, region, rental period, connection situation and market conditions. They are neither a price guarantee nor an offer.

| Variant | Used purchase approx. | New purchase approx. | Rental per month approx. |
| --- | --- | --- | --- |
| **Toilet container, small (10 ft)** | €5,000 – 9,000 | €11,000 – 18,000 | €200 – 400 |
| **Toilet container, 20 ft** | €7,000 – 13,000 | €15,000 – 26,000 | €280 – 550 |
| **Shower container, 20 ft** | €8,000 – 15,000 | €17,000 – 30,000 | €320 – 650 |
| **Combined WC + shower, 20 ft** | €9,000 – 16,000 | €19,000 – 32,000 | €350 – 700 |
| **Accessible version** | €10,000 – 18,000 | €22,000 – 38,000 | €400 – 800 |
| **Tank version** | Surcharge €1,500 – 4,000 | Surcharge €2,000 – 6,000 | Surcharge €60 – 150 |

Ancillary costs weigh more heavily with sanitary containers than with other types:

| Item | Approx. magnitude | Note |
| --- | --- | --- |
| **Delivery / collection** | €300 – 900 per trip | Distance-dependent, crane possibly extra |
| **Water / waste water / power hook-up** | €400 – 2,500 | Heavily dependent on pipe runs and lifting station |
| **Cleaning service** | €40 – 120 per visit | Depending on size and interval |
| **Tank emptying** | €150 – 400 per collection | Depending on volume and disposal route |
...
- How many people use the facility at the same time, and what is the female / male ratio?
- Is accessible provision required?
- Are connections for water, sewer and power available – or is a tank solution needed?
- Is the available electrical capacity sufficient for the planned water heating?
- Who cleans at what interval, and is that contractually agreed?
- Who restocks consumables?
- Is operation planned through the winter, and is frost protection budgeted?
- Is the ground load-bearing and precisely level?
- Have disposal intervals and costs been calculated?

## Conclusion

Sanitary containers are technically the most demanding standard container category, because they require water, waste water, power and heat at once and because their value depends on day-to-day operation. The decision is rarely made on the module itself, but on three questions: which connections are available on site, who handles cleaning and restocking, and will it run through the winter? Anyone who settles these points before ordering ends up with an installation that simply works – and with sanitary facilities that is the only measure that counts.
